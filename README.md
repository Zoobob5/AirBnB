...
* Request
  * Method: POST
  * URL: /user/:userId/reviews/:reviewId/(images maybe)
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: /user/:userId/booking/:bookingId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: /user/:userId/spot/:spotId/images/:imageId
  * Body: none
...
* Request
  * Method: DELETE 
  * URL: /user/:userId/review/:reviewId/images/:imageId
  * Body: none
